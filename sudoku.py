...
def find_possible_values(grid: tp.List[tp.List[str]], pos: tp.Tuple[int, int]) -> tp.Set[str]:
    ...
    a = set(get_block(grid,(pos)))
    b = set(get_col(grid,(pos)))
    c = set(get_row(grid,(pos)))
    values = set(values.difference(a, b, c))
    return values
